...
class _CreateSessionScreenState extends State<CreateSessionScreen> {
              ...
              if (_lat != null)
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontFamily: 'monospace', fontSize: 11, color: Colors.white.withValues(alpha: 0.4)),
                  ),
                ),
            ],
  ...
  Widget _label(String text) => Padding(
    ...
    child: Text(text, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.white.withValues(alpha: 0.5), letterSpacing: 0.5)),
  );
}
